...
#define STRING_CONFIG_H_AUTHOR "(mlee12382, Elegoo Neptune)" // Who made the changes.
...
// #define HAS_WIFI                  // uncomment if you have wifi module installed, NOT WORKING with COLORUI or N3!
